...
const navLinks = [
    ...
    { href: "/client/documents", label: "Mis Documentos", icon: FolderKanban },
    { href: "/client/tasks", label: "Mis Tareas", icon: FolderKanban },
    { href: "/client/messages", label: "Mensajería", icon: MessageSquare },
];
        ...
        <div className="flex w-full items-center justify-end gap-4 md:ml-auto md:gap-2 lg:gap-4">
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              <DropdownMenuLabel>Tech Innovators Inc.</DropdownMenuLabel>
